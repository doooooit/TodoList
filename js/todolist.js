function registry() {
    ...
    reg.style.top = (h - reg.offsetHeight) / 2 - 30 + "px";
    reg.style.left = (w - reg.offsetWidth) / 2 + "px";
    ...
    cancel.onclick = function () {
        document.body.removeChild(document.querySelector('#registry-container'));
